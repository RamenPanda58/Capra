...
namespace WrightAngle.Waypoint
{
    ...
    public class WaypointSettings : ScriptableObject
    {
        ...
        [Tooltip("Vertical offset (in world units) applied to all waypoint markers. Positive moves the marker above the target.")]
        public Vector3 MarkerWorldOffset = new Vector3(0f, 2f, 0f);
